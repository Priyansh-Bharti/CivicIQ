...
export class TranslationEngine {
  ...
  private static readonly translations: Record<string, Record<string, string>> = {
    ...
    'chat.input.disclaimer':       { en: '🛡️ Non-partisan · Factual only', hi: '🛡️ गैर-पक्षपाती · केवल तथ्यात्मक', es: '🛡️ No partidista', ar: 'محايد', fr: '🛡️ Non partisan', de: '🛡️ Unparteiisch', zh: '🛡️ 无党派' },
    'chat.panel.context':          { en: 'Asking about: ', hi: 'के बारे में पूछना: ', es: 'Preguntando por: ', ar: 'يسأل عن: ', fr: 'Interroger sur: ', de: 'Frage zu: ', zh: '询问关于：' },
    'chat.panel.disclaimer':       { en: 'AI can make mistakes. CivicIQ only covers election processes.', hi: 'AI गलतियाँ कर सकता है।', es: 'La IA puede cometer errores.', ar: 'قد يخطئ الذكاء الاصطناعي.', fr: 'L\'IA peut faire des erreurs.', de: 'KI kann Fehler machen.', zh: 'AI 可能会犯错。' },
